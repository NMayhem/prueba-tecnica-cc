...
public class Startup {
	...
	public void runAfterStartup() {
        ...
        try {
            ...
            usr1.setPassword(aesEncryptionComponent.cbcEncrypt("password1"));
            usr1.setTaxId("ABCD990101XX0");
    
            usr2.setEmail("user2@mail.com");
            usr2.setName("user2");
            usr2.setPhone("+15555555556");
            usr2.setPassword(aesEncryptionComponent.cbcEncrypt("password2"));
            usr2.setTaxId("ABCD990101XX1");
    
            usr3.setEmail("user3@mail.com");
            usr3.setName("user3");
            usr3.setPhone("+15555555557");
            usr3.setPassword(aesEncryptionComponent.cbcEncrypt("password3"));
